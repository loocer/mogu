(function () {
   ...
   class GameUI extends Laya.Scene {
       constructor() {
           ...
           // // camera.active=false
           console.log(camera,'88888888888888888888888');
           camera.getChildByName('GameObject').getChildByName('Main Camera').clearColor = new Laya.Vector4(0, 0, 0, 1);
       ...
       drawUi() {
           ...
           let bottom = this.loadingElse.get('bottom');
           ...
           let left = this.loadingElse.get('left');
           ...
           let right = this.loadingElse.get('right');
           ...
           let top = this.loadingElse.get('top');
           ...
           let roteLeft = this.loadingElse.get('rote');
           ...
           let upLeft = this.loadingElse.get('down');
